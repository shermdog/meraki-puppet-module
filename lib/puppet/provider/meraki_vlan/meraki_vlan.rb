  ...
  def get(context)
    ...
    vlans.map do |vlan|
      instances << {
        ...
        fixedipassignments: vlan['fixedIpAssignments'].size > 0 ? vlan['fixedIpAssignments'] : nil,
        reservedipranges: vlan['reservedIpRanges'].size > 0 ? vlan['reservedIpRanges'] : nil,
